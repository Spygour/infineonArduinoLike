...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED         &MODULE_P00,2
#define LED2        &MODULE_P00,5
...
void setPinInputPullup(Ifx_P *port, uint8 pinIndex){
    IfxPort_setPinModeInput(port,pinIndex, IfxPort_Mode_inputPullUp);
}
void setPinInputPuldown(Ifx_P *port, uint8 pinIndex){
    IfxPort_setPinModeInput(port,pinIndex, IfxPort_Mode_inputPullDown);
}
