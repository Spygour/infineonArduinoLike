...
{
  while (IfxI2c_I2c_read(myi2cdev, &data[0], size) == IfxI2c_I2c_Status_nak);
}
...
void I2c_ReadRegister(IfxI2c_I2c_Device* myi2cdev,uint8 registerAddress, Ifx_SizeT size,volatile uint8* myRxTxBuffer)
{
    ...
    while (IfxI2c_I2c_read(myi2cdev, &myRxTxBuffer[0], size) == IfxI2c_I2c_Status_nak);
}
...
{
  while(IfxI2c_I2c_SlaveRead(myi2cdev,&I2cSlaveBuffer[0],size) == IfxI2c_I2c_Status_nak);

}

void I2c_WriteSlave(IfxI2c_I2c_Device* myi2cdev,Ifx_SizeT size,volatile uint8* I2cSlaveBuffer)
{
  while(IfxI2c_I2c_SlaveWrite(myi2cdev,&I2cSlaveBuffer[0],size) == IfxI2c_I2c_Status_nak);
